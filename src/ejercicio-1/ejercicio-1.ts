...
console.log(MovieCollection1.getByYear(1994));
console.log(MovieCollection1.getByTitle("The Shawshank Redemption"));
console.log(DocumentaryCollection1.getByGenre("Sports"));
console.log(SerieCollection1.getByDuration(300));
console.log(DocumentaryCollection1.getByRating(9.2));
console.log(MovieCollection1.getTitles());
console.log(DocumentaryCollection1.getYears());
console.log(SerieCollection1.getGenres());
console.log(MovieCollection1.getDurations());
